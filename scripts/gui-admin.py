...
# #======= extra for exe file setup============#
# # Finds the absolute path of the scripts folder
# SCRIPTS_DIR = os.path.dirname(os.path.abspath(__file__))

# # Moves up one level to the main folder, then into the site folder
# SITE_DIR = os.path.abspath(os.path.join(SCRIPTS_DIR, "..", "site"))

# # Example: How to target specific pages or folders inside your code
...
#     knowledge_centre_html = knowledge_centre_path.read_text(
#         encoding="utf-8"
#     )
...
#     # <div class="grid g3">
#     article_grid_marker = '<div class="grid g3">'

#     article_already_exists = (
#         f'href="knowledge/{slug}.html"' in knowledge_centre_html
#     )
...
#             knowledge_centre_html = knowledge_centre_html.replace(
#                 article_grid_marker,
#                 article_grid_marker + "\n" + new_article_card,
#                 1
#             )
...
#                 "Knowledge Centre",
#                 "Article was created, but the article grid "
#                 "could not be found in knowledge-centre.html."
#             )


#     # -----------------------------------------------------
#     # 2. UPDATE BLOGPOST JSON-LD
#     # -----------------------------------------------------
#     if not article_already_exists:
...
#             "@type": "BlogPosting",
#             "headline": title,
#             "url": f"https://arcubus.in/knowledge/{slug}.html",
...
#         # Convert the Python dictionary into valid JSON
...
#                 "Article was created, but the BlogPosting "
#                 "JSON-LD section could not be found."
#             )


#     # -----------------------------------------------------
#     # 3. SAVE UPDATED KNOWLEDGE CENTRE
#     # -----------------------------------------------------
