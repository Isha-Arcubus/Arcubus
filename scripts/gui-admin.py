...
# # Pillow allows us to show JPG/JPEG/WebP images in the
# # live preview.
# #
# # If Pillow is not installed, the application still works.
# # It will simply display an image placeholder in the preview.
...
#             "intra-group services is critical to achieving "
...
#             self.update_image_layout_preview(
#                 item_data
#             )

#         # When Centre / Left / Right changes
#         align_var.trace_add(
#             "write",
#             update_preview
#         )
...
#     def update_image_layout_preview(self, item_data):

#         canvas = item_data.get(
#             "preview_canvas"
#         )
...
#         # -------------------------------------------------
#         # Article/document boundaries
#         # -------------------------------------------------

#         left_margin = 25
#         right_margin = canvas_width - 25
...
#         align = item_data["align"].get()

#         # -------------------------------------------------
#         # Selected image
#         # -------------------------------------------------

#         image_path = item_data["path"].get().strip()
...
#                 item_data["preview_image"] = None

#         # =================================================
#         # IMAGE PLACEHOLDER FUNCTION
#         # =================================================

#         def draw_placeholder(x, y):
...
#             if (
#                 actual_image_loaded
#                 and item_data.get("preview_image")
#             ):

#                 canvas.create_image(
#                     x,
#                     y,
#                     image=item_data["preview_image"],
#                     anchor="nw"
#                 )
...
#                 canvas_width / 2,
#                 165,
#                 text="Centre — image centred in the article",
#                 fill="#555555",
#                 font=("Segoe UI", 8)
#             )
...
#         name = (
#             self.add_person_name
#             .get()
#             .strip()
#         )

#         role = (
#             self.add_person_role
#             .get()
#             .strip()
#         )
...
#         expertise1 = (
#             self.add_person_expertise1
#             .get()
#             .strip()
#         )

#         expertise2 = (
#             self.add_person_expertise2
#             .get()
#             .strip()
#         )

#         image_path = (
#             self.add_person_image
#             .get()
#             .strip()
#         )
...
#                 f"Delete this person from the Our People page?\n\n"
#                 f"{person['name']} — {person['role']}\n\n"
#                 f"This will remove the visible card and "
#                 f"its Person JSON-LD entry."
#             )
...
#             .strip()
#             or
#             f"{title} — practical guidance from Arcubus Advisors."
#         )

#         tk_list = [
#             t.strip()
#             for t in self.art_takeaways
#             .get(
#                 "1.0",
#                 "end"
#             )
